...
# v000 2012-07-10,11 `lftpd` a kind of master<->slave file sync daemon
# v001 2012-07-12 testing loop
# v002 2012-08-22 testing + production: APP config selection
# v003 2012-12-05 lftpd: nodenwer+SUPro adoption
# v004 2013-02-27 lftpd: split $ROOTDIR for up and downloading
# v005 2013-02-28 lftpd_supro: fork for SUPro, `og` -> `zog` to be last in uploaded files
# v006 2013-03-11 lftpd_supro: no LAPP, move income into $LIDIR by supromvincome.sh
# v007 2013-04-19 lftpd_supro: bashizm in `test`: "==", cygwinizm: `ps -W` -> $PS_OPTS
