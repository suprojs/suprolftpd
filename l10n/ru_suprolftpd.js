l10n.lftpd = { lang: 'ru' //!!! локализация используется только в UI (для простоты обновления)
    ...
    ,testBegin: 'Тест начало'
    ,testEnd: 'закончить тест'
    ,testSend: 'посылает сообщение; результат <b>"up" OK</b>'
    ,testOn: 'после <b>send+"up" OK</b> на точке обмена есть файл(ы); получить'
    ,sts:{
